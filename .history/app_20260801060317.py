...
st.markdown("""
<style>
.stApp {background:linear-gradient(135deg,#F8FAFC 0%,#EFF6FF 100%);color:#0F172A}
.block-container {padding-top:1.6rem;padding-bottom:3rem;max-width:1450px}
#MainMenu,footer,header {visibility:hidden}
section[data-testid="stSidebar"] {background:linear-gradient(180deg,#0F172A,#1E293B);border-right:1px solid rgba(255,255,255,.08)}
section[data-testid="stSidebar"] * {color:white}
div[role="radiogroup"] label {padding:9px 11px;border-radius:10px;margin-bottom:3px}
div[role="radiogroup"] label:hover {background:rgba(255,255,255,.10)}
h1 {color:#1D4ED8;font-weight:800} h2,h3 {color:#0F172A}
div[data-testid="metric-container"] {background:white;border-radius:18px;padding:20px;box-shadow:0 8px 24px rgba(15,23,42,.10);border-left:6px solid #2563EB}
.stButton>button,.stDownloadButton>button {width:100%;height:50px;border:0;border-radius:12px;color:white;font-weight:700}
.stButton>button {background:linear-gradient(90deg,#2563EB,#4F46E5)}
.stDownloadButton>button {background:#059669}
div[data-testid="stPlotlyChart"],div[data-testid="stDataFrame"] {background:white;padding:10px;border-radius:16px;box-shadow:0 6px 20px rgba(15,23,42,.08)}
div[data-testid="stAlert"] {border-radius:14px}
div[data-baseweb="select"]>div,div[data-baseweb="input"] {background:white!important;color:#0F172A!important}
div[data-testid="stNumberInput"] input {background:white!important;color:#0F172A!important;-webkit-text-fill-color:#0F172A!important}
div[data-baseweb="select"] span {color:#0F172A!important;-webkit-text-fill-color:#0F172A!important}
</style>
